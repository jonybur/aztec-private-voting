...
**Placement:** M4 appears **after** the primary comprehension (M1/Q-AC) and trust (M2) blocks - not immediately after the calibration feedback screen. This placement is intentional: participants see the actual receipt before rating their retrospective confidence, so their post-receipt understanding can inform how they assess their pre-receipt calibration probe answers. Asking M4 before the receipt would conflate pre-receipt and post-receipt confidence; asking after allows the receipt to anchor the retrospective judgment. (Consistent with instrument §11.)
