...
**Updated:** tick-4498 (2026-07-02 15:28 UTC)
**Status:** 7 open Jony actions + 1 optional (Volkamer 2022 §1.4 applied tick-4490, pending Jony confirm/revert)
...
### Decision D — Volkamer 2022 §1.4 insertion ✅ APPLIED (tick-4490)

**✅ Applied at tick-4490.** The sentence and bibliography entry are in the paper. §1.4 now reads:
...
**Volkamer et al. (2022)** is entry #18 in the references (SOUPS 2022, pp. 233–252, USENIX, venue confirmed usenix.org/conference/soups2022/presentation/volkamer).

**Jony action:** Review the applied edit and confirm (or request revert). Paper word count annotation already updated tick-4498. No further agent action needed on Decision D.
...
| CHI paper body | ✅ 11,661 words (tick-4497: §3.3 +1w; tick-4496: §2.2 −27w; prior: abstract trim, §7 compression), all sections written |
| Bibliography | ✅ 18/18 entries verified (Volkamer 2022 added + confirmed tick-4490) |
