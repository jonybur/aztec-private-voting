...
A single coercion demand vignette has been used in voting UX studies (Kulyk et al. 2017 on coercibility perception in remote electronic voting) [Unverified tick-4049; CONFIRMED NOT IN DBLP tick-4054: DBLP direct search 2026-06-27 returns zero results for 'kulyk interact 2017' — this citation does not exist in any indexed venue. See References note. Jony action required before submission.]; the current protocol adapts that design to the private-voting receipt context.
...
- Kulyk, O., et al. (2017). Does my vote count? Voter experience with verifiability in internet voting. *INTERACT 2017*. [CONFIRMED NOT IN DBLP tick-4054 (2026-06-27): DBLP direct search returns zero results for 'kulyk interact 2017'. Previously: DBLP listed all 8 Oksana Kulyk 2017 publications — none match this title or venue (tick-4049). Google Scholar returns zero results for this exact title+author+year combination. Body text (§3.3) describes the paper as about 'coercibility perception' while the title refers to 'verifiability' — internal inconsistency. This citation does NOT exist in indexed literature. Jony must either: (a) supply the correct DOI/page-range if it exists as an unindexed workshop paper, (b) replace with the correct citation for the coercion-vignette precedent (e.g. Nissen et al. EVT/WOTE 2025 'Voting Under Pressure', or a different Kulyk paper), or (c) remove the citation and rephrase as protocol design rationale without a precedent citation. Action required before submission. Do NOT submit with this reference.]
