...
A single coercion demand vignette has been used in voting UX studies (Nissen et al. 2025 on coercibility perception in remote electronic voting); the current protocol adapts that design to the private-voting receipt context.
