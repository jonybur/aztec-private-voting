...
**Live testnet deployment** - `[CONTRACT ADDRESS]` (v5.testnet.rpc.aztec-labs.com - rollupVersion `2787991301` stable, endpoint verified Jul 2 2026 (block 1760); artifact compiled and ready `contracts/target/`; deploy immediately before submitting and replace this placeholder)
