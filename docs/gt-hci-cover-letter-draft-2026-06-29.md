...
My name is Jony Bursztyn. I am a software engineer and researcher who has spent the past two years building a private voting system on Aztec Network, a ZK rollup that allows smart contracts to hold private state without revealing it. The cryptographic machinery was, in a meaningful sense, solved: zero-knowledge proofs can guarantee ballot privacy, individual verifiability, and coercion resistance simultaneously. What was not solved was the question of what to put on the receipt — how to communicate to a non-technical voter that their vote was counted, without the receipt revealing what the vote was. That design tension is not resolvable by a cryptographer. It requires human factors work.
