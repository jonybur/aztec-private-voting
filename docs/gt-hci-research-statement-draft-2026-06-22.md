...
- **Faculty targeting — ⚠️ VERIFY BEFORE SUBMITTING:** The previous draft referenced "Apu Das" — this name does not correspond to any real GT HCI faculty member and was a fabrication. The intended researcher was **Sauvik Das** (SPUD Lab — Security, Privacy, Usability and Design), who directed that lab at GT and whose work on social influence in security adoption (CCS 2014: "Increasing Security Sensitivity With Social Proof: A Large-Scale Experimental Confirmation") is directly relevant to the PIUP's verification-behavior thesis. However: **Sauvik Das moved to CMU HCII (as Associate Professor) as of 2025–26.** GT may no longer have a dedicated security+privacy HCI researcher with this profile. Before submitting to GT, verify current IC faculty focus areas at https://ic.gatech.edu/people. If applying to **CMU** as a backup (or primary), Sauvik Das is the natural fit: cite the CCS 2014 Facebook social nudge paper and name the CMU SPUD Lab (https://cs.cmu.edu/~spudlab).
