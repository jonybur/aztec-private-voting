...
_Last updated: tick-3994 (2026-06-27). JONY-ACTION H RESOLVED tick-3994: Norman (1988, p. 27) page number added to §6.3 citation. Paraphrase confirmed essentially verbatim (DOET p. 27: 'sending back to the user information about what action has actually been done, what result has been accomplished'; paper: 'the system must send back to the user information about what action was done and what result was accomplished'). [JONY-ACTION H] block replaced with [Fixed tick-3994]. JONY-ACTION G re-verified tick-3993: design-rationale reframe INTACT at §2.1 line 136; fresh repo-wide search confirms NO new N=12 pilot documentation exists; option (b) is the confirmed CHI-safe path; G remains open pending Jony’s explicit option-(b) confirmation before submission. JONY-ACTION I verified tick-3992: D APPLIED tick-3819 (no amendment); E instrument APPLIED tick-3819 (OSF amendment pending upload); A/B/C awaiting Jony decisions. JONY-ACTION J analysis complete tick-3991: ordering CONFIRMED E&S-first at §2.1 (line 134) and §2.2 (line 146) — applied tick-3876. W&T retention analysis: W&T cited at 5 locations; RECOMMENDATION: RETAIN co-citation E&S-first. Note blocks replaced with [Fixed tick-3991] at both sites. J awaiting Jony pre-CHI confirmation of RETAIN (accept = no change needed). Low-blocking. Open: J (confirm W&T), I (A/B/C pending Jony + OSF), G (confirm option-b), N, (Das), A, B, C, O, P, Q, R + [verification URL] (12 items). H RESOLVED tick-3994; L RESOLVED tick-3990; M RESOLVED tick-3989; U RESOLVED tick-3988; T RESOLVED tick-3987; X RESOLVED tick-3986; W RESOLVED tick-3985; V RESOLVED tick-3984._
