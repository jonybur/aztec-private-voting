...
H2 is considered **reversed** if H2-primary favours B (B > A on Q2 at α = 0.05, tested post-hoc). [Amendment 15 (pre-data): analysis script line 571 used p_one_tailed for this post-hoc test, equivalent to two-tailed α = 0.10. Script comment on the same line read 'two-tailed; only if primary not significant' — the developer intent was two-tailed but the implementation was wrong. Corrected to p_two_tailed < 0.05 before OSF upload. No protocol, hypothesis, alpha level, or primary analysis change. See §14 and osf-amendment-filing-2026-06-24.md Amendment 15.]
...
- **Q5 (open-ended, scored separately):** "Why might the system choose not to show you your vote choice on this screen?" [Amendment 12 (pre-data): instrument §6/Q5 has 4 wording deviations from this pre-reg §5.2 text: (a) 'In your own words:' prefix added; (b) 'the system' → 'this voting system'; (c) lowercase 'not' → emphasized 'NOT'; (d) 'your vote choice' → 'which option you voted for'. Deployed instrument Q5 wording: 'In your own words: why might this voting system choose NOT to show you which option you voted for on this screen?' Scoring rubric (0–2) and κ ≥ 0.70 requirement unchanged. Parallel to Amendments 6, 7, 8. See §14 and osf-amendment-filing-2026-06-24.md Amendment 12.]  
...
**Mental model quality (RQ3, open text):** After Q1–Q4, participants answer: "In your own words, what does this value prove about your vote?" Free text, scored 0–2 (0 = no correct element; 1 = correctly states inclusion without choice; 2 = explicitly states choice is hidden from system). Two raters; κ ≥ 0.70 required. [Amendment 8 (pre-data): wording updated to 'In your own words: what does your [LABEL] prove about your vote?' — 'this value' replaced with 'your [LABEL]'; colon added. Two-rater scoring construct (0–2; κ ≥ 0.70) unchanged. Parallel to Amendments 6 (Q1) and 7 (Q2). Note: Amendment 2 (VOID) addressed a separate two-part form reversion; this amendment documents the independent '[LABEL]' substitution deviation. See §14 and osf-amendment-filing-2026-06-24.md.] [Amendment 13 (pre-data): the pre-reg §5.3 abbreviated rubric ('0 = no correct element; 1 = correctly states inclusion without choice; 2 = explicitly states choice is hidden from system') is operationalized by the two-dimensional additive rubric in instrument §11: Dim 1 (Inclusion) + Dim 2 (Non-leakage), scored independently, total = D1+D2. Non-leakage-only responses (correctly states choice is hidden but does not mention inclusion) score Dim 1=0 + Dim 2=1 = 1, consistent with abbreviated score 1. Amendment 8 log entry 'scoring construct unchanged' is corrected: the two-dimensional rubric is the operative operationalization; the abbreviated 0–2 scale is the reporting summary. MQ1 is exploratory; no confirmatory analysis affected. See §14 and osf-amendment-filing-2026-06-24.md Amendment 13.]

**Behavioral intent (RQ2 proxy):** "If this screen appeared after a real vote, would you download this file?" (5-point: Definitely yes → Definitely no.) [Amendment 3 (pre-data): wording updated to 'If this was a real election and you saw this screen after submitting your vote, how likely would you be to save this code for future reference?' (5-point: Definitely would save it → Definitely would not save it.) Rationale: (a) 'save for future reference' makes the verification purpose explicit, better operationalising behavioral intent to preserve the receipt; (b) 'this code' replaces '[LABEL]' to remove label-name demand from the behavioral intent measure — BI1 should measure save intention, not label-schema association; (c) response scale direction preserved. See §14 and osf-amendment-filing-2026-06-24.md §Item E.] [Amendment 16 (pre-data): the Amendment 3 scale description '(5-point: Definitely would save it → Definitely would not save it)' implies higher codes correspond to less save intention (1 = save, 5 = not-save). Instrument §7 code table has the opposite mapping: 5 = Definitely would save it, 1 = Definitely would not save it (higher code = stronger save intention). Corrected description: (5-point: 1 = Definitely would not save it, 5 = Definitely would save it; higher score = stronger save intention). No analysis impact — BI1 is exploratory with no pre-specified confirmatory test. Parallel to paper §4.4 fix (tick-4171). See §14 and osf-amendment-filing-2026-06-24.md Amendment 16.]
...
- Prolific attention checks: 2 items ("Which of the following is a fruit? / Please select 'strongly agree' for this item.") [Amendment 14 (pre-data): both descriptions in this pre-reg §3 line are inaccurate. AC1 correct answer is 'Strongly Disagree' (not 'strongly agree'). AC2 does not ask 'which of the following is a fruit?' — it presents a list and asks participants to select the third item; the correct answer is Carrot (a vegetable, not a fruit). The both-fail exclusion criterion and its analysis script implementation are correct; only this pre-reg text description is wrong. See §14 and osf-amendment-filing-2026-06-24.md Amendment 14.]
...
**H4-confidence:** One-way ANOVA on confidence composite (mean Q1–Q4). If significant (F test α = 0.05), Tukey HSD post-hoc for B vs. A, B vs. C, B vs. D. [Amendment 18 (pre-data): analysis script ran TukeyHSD() regardless of ANOVA significance and did not gate h4_support on the omnibus p-value. Fixed before OSF upload: (1) anova_sig flag added (f_pval < 0.05); (2) h4_support now requires anova_sig AND all three Holm-corrected Tukey comparisons significant AND correct direction; (3) H4-null verdict branch added — when ANOVA non-significant, Tukey HSD is computed and printed descriptively but labelled exploratory, and h4_support = FALSE; (4) H4-partial branch added — ANOVA significant but ≤ 2/3 Tukey comparisons surviving. No hypothesis, alpha level, protocol, or sample size change. See §14 and osf-amendment-filing-2026-06-24.md Amendment 18.]  
...
| 2026-06-28 | 12 | Instrument wording — Q5 | Q5 stem has 4 wording deviations from pre-reg §5.2: (a) 'In your own words:' prefix added; (b) 'the system' → 'this voting system'; (c) 'not' → 'NOT' (emphasis added); (d) 'your vote choice' → 'which option you voted for'. Deployed instrument §6/Q5 wording: 'In your own words: why might this voting system choose NOT to show you which option you voted for on this screen?' Scoring rubric (0–2) and κ ≥ 0.70 requirement unchanged. Parallel to Amendments 6, 7, 8. See osf-amendment-filing-2026-06-24.md Amendment 12. (Pre-data.) | OpenClaw Agent |
| 2026-06-28 | 13 | Scoring rubric clarification — MQ1 | MQ1 two-dimensional additive rubric in instrument §11 is the operative operationalization: Dim 1 (Inclusion) + Dim 2 (Non-leakage), total = D1+D2. Pre-reg §5.3 abbreviated rubric (0 = no correct element; 1 = inclusion without choice; 2 = choice hidden) is the reporting summary. Non-leakage-only responses score Dim 1=0 + Dim 2=1 = 1 (consistent with abbreviated score 1). Amendment 8 log entry 'scoring construct unchanged' corrected: two-dimensional rubric is operative. MQ1 is exploratory; no confirmatory analysis affected. See osf-amendment-filing-2026-06-24.md Amendment 13. (Pre-data.) | OpenClaw Agent |
| 2026-06-28 | 14 | Attention check descriptions correction | Pre-reg §3 describes AC1 correct answer as 'strongly agree' — actual correct answer is 'Strongly Disagree'. Pre-reg §3 describes AC2 as 'Which of the following is a fruit?' — actual AC2 presents a list and asks participants to select the third item; correct answer is Carrot (a vegetable). Both-fail exclusion criterion and analysis script implementation are correct; only this pre-reg text is inaccurate. See osf-amendment-filing-2026-06-24.md Amendment 14. (Pre-data.) | OpenClaw Agent |
| 2026-06-29 | 15 | Analysis script — H2 verdict bug fix | H2 reversed-verdict criterion corrected: analysis script line 571 used p_one_tailed < 0.05 for the post-hoc B > A test, equivalent to two-tailed α = 0.10. Script comment stated 'two-tailed; only if primary not significant' — only the code was wrong. Corrected to p_two_tailed < 0.05 before OSF upload. No protocol, hypothesis, alpha level, or primary analysis change. (Pre-data.) | OpenClaw Agent |
| 2026-06-29 | 16 | BI1 scale direction — pre-reg description inverted | Pre-reg §5.2 Amendment 3 note described BI1 scale as '(5-point: Definitely would save it → Definitely would not save it)', implying 1 = save, 5 = not-save. Instrument §7 code table: 5 = Definitely would save it, 1 = Definitely would not save it (higher code = stronger save intention). Corrected to '(5-point: 1 = Definitely would not save it, 5 = Definitely would save it; higher score = stronger save intention)'. No protocol or analysis impact (BI1 exploratory; no pre-specified confirmatory test). Parallel to paper §4.4 fix (tick-4171). See osf-amendment-filing-2026-06-24.md Amendment 16. (Pre-data.) | OpenClaw Agent |
| 2026-06-29 | 17 | Inclusion/exclusion criteria wording | (1) SC1: Pre-reg §3 'online vote, poll, or election' corrected to 'online election, poll, or survey' to match instrument §SC1 deployed text (which added 'survey' as an eligible activity type). (2) SC2: 'cryptography as primary occupation' removed from exclusion description — instrument §SC2 does not list cryptography as a screen-out option; analysis script uses COL\_OCCUPATION = 'occupation\_sw\_eng'. No protocol or analysis impact; corrections to pre-reg description text only. (Pre-data.) | OpenClaw Agent |
| 2026-06-29 | 18 | Analysis script — H4 verdict bug fix | H4 analysis script did not gate h4\_support on ANOVA omnibus significance: script ran TukeyHSD() regardless of ANOVA result and h4\_support checked only Tukey comparisons without first requiring anova\_sig. Fixed: h4\_support now requires anova\_sig (f\_pval < 0.05) AND all three Holm-corrected Tukey comparisons significant AND correct direction. H4-null verdict branch added (ANOVA non-significant → no confirmatory pairwise extraction; Tukey HSD computed descriptively/exploratory). H4-partial branch added (ANOVA significant but ≤ 2/3 comparisons surviving). No protocol, hypothesis, alpha level, or sample size change. (Pre-data.) | OpenClaw Agent |
