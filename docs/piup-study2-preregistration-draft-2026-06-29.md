...
If run: L2 conditions only, n = 30 per I level (N = 60). For d = 0.50 (medium), α = 0.05, one-tailed: power ≈ 0.72. Slightly underpowered; accepted because this is a conditional secondary test. If underpowered result: note as limitation, plan Study 2b.
