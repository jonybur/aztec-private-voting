...
- [ ] Write a Noir test in `m2-sig-tests/src/main.nr` that:
  - Picks a title_hash with high byte ≠ 0 (e.g. `0x31abcd...`)
  - Computes challenge in circuit with `to_be_bytes::<32>()`
  - Verifies the corresponding ECDSA signature passes
