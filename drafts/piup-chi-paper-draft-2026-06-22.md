...
_Word count: ~11,660 words (tick-4496: §2.2 Alt-4 redundancy trim –27w; tick-4495: no net change; tick-4494 net: 11,687w after abstract trim –69w tick-4493, §2.3 trim –42w tick-4492). 18 references. §4.6 fill-in adds +245–405w → final ~11,905–12,065w: ✅ lower bound fits cap (95w buffer); trim (~65w) needed only if §4.6 fills at upper bound. CHI cap 12,000 incl. refs, excl. tables. Abstract: 150 words (at CHI abstract cap). Open actions: JONY-ACTION O (OSF Amendment 5) + JONY-ACTION T (OSF Amendments 12+13+14). Also open: Amendments 19, 19b (pre-pilot). See docs/jony-action-brief-2026-07-02.md._
