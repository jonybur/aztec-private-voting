...
The H4 prediction — that "confirmation code" produces higher confidence than "vote fingerprint" despite comparable or lower accuracy on privacy-model items — operationalizes this miscalibration. Confidence is high because the eCommerce association activates a well-practiced schema. Accuracy on the privacy-specific questions (Q2: "does this prove which option you voted for?"; Q3: "could someone learn how you voted from a screenshot?") is lower because the activated schema directly contradicts the correct answer. The label does the designer's work of reducing friction while simultaneously doing the coercer's work of producing a wrong mental model.
