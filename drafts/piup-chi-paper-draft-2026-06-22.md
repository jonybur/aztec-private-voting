...
_Word count: ~11,683 words (tick-4493: abstract –69w — trimmed 219w→1 paragraph 150w to meet CHI abstract cap; tick-4492: –42w §2.3 trim). 18 references. §4.6 fill-in adds +245–405w → final ~11,928–12,088w: ✅ lower bound fits cap (72w buffer); trim (~88w) needed only if §4.6 fills at upper bound. CHI cap 12,000 incl. refs, excl. tables. Abstract: 150 words (at CHI abstract cap). Open actions: JONY-ACTION O (OSF Amendment 5) + JONY-ACTION T (OSF Amendments 12+13+14). Also open: Amendments 19, 19b (pre-pilot). See docs/jony-action-brief-2026-07-02.md._
...
**📏 WORD COUNT - UPDATED tick-4495 (2026-07-02):** Body text (annotations + submission notes stripped, refs included): **~11,687 words** (tick-4494 net after abstract trim –69w tick-4493, §2.3 trim –42w tick-4492, §7 invariants fill +107w tick-4491, Volkamer 2022 +22w tick-4490). 18 references. UNDER the 12,000 desk-rejection threshold. §4.6 contains ~145 [SLOT] markers; when filled, word count rises +245–405 → final: ~11,932–12,092 words. **Lower bound fits cap (68w buffer); light trim (~92w) only needed if §4.6 fills at upper bound; do not pre-cut.** Trim target (if needed): §4.6 narrative or §6.4 examples, NOT §6.1/§6.3/§7. DO NOT cut §6.1 (core design argument), §6.2 (trimmed), §6.3 (feedback inversion), §7 (conclusion), §4.5 (~440 words - done).
...
7. ✅ CHI 2027 word limit and formatting confirmed (tick-4271): 5,000-8,000 encouraged; 12,000 max. Body currently **~11,705 words (under limit)** [updated tick-4490 — +22w Volkamer 2022; prior 11,683 tick-4467; 11,823 tick-4418; 11,787 tick-4397; 11,707 tick-4369; 11,535 post-trim tick-4332; 18 refs]. After §4.6 slot fill-in: ~11,950–12,110 — light trim (~110w) only needed if §4.6 fills at upper bound; lower-end fill clears under 12,000. Do not pre-cut: trim only after §4.6 is filled.
