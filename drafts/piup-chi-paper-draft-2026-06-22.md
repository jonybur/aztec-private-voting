...
**Status line.** A direct statement that the submission was received and processed: *"Your ballot has been counted"* or equivalent. The status line must appear before any other receipt content. Per Egelman and Schechter (2013), users who encounter unexpected content sequences will pattern-match from prior experience; placing the status line first anchors the user's interpretation before the absent content becomes salient.
