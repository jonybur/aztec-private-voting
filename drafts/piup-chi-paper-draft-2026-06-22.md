...
**H1:** A > D on Q2 and Q3 (fingerprint > neutral baseline on the privacy-model questions; pre-registered directional magnitude: ≥ 10 pp on each).
...
**H3:** C < all others on Q1 ("does this prove your vote was counted?") and on overall accuracy composite - reversal risk from "nullified" reading; 6 pre-registered tests (Q1(C<A), Q1(C<B), Q1(C<D), composite C<each); pre-registered directional magnitudes: Cond C < 45% on Q1, Cond A ≥ 65% on Q1.
