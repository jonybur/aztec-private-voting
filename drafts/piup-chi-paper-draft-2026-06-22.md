...
**📏 WORD COUNT - UPDATED tick-4369 (2026-07-01):** Body text (annotations + submission notes stripped, refs included): **~11,707 words** (tick-4369 script estimate; tick-4332 post-trim was ~11,535; +172w from ticks 4333–4369 content additions). 17 references (16→17: Faul et al. added tick-4045). UNDER the 12,000 desk-rejection threshold. §4.6 contains ~145 [SLOT] markers; when filled, word count rises +245–405 → final: ~11,950–12,112 words. If post-fill total exceeds 12,000, one targeted trim pass (~300w from §4.6 narrative or §6.4 examples) will bring it in. **Paper is comfortably under 12,000 pre-fill.** DO NOT cut §6.1 (core design argument), §6.2 (trimmed), §6.3 (feedback inversion), §7 (conclusion), §4.5 (now at ~440 words - done).
