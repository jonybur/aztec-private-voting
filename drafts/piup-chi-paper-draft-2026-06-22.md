...
**📏 WORD COUNT - UPDATED tick-4397 (2026-07-01):** Body text (annotations + submission notes stripped, refs included): **~11,787 words** (tick-4397 estimate: 11,707 base + ~80w Studies 3+4 §7 addition). 17 references. UNDER the 12,000 desk-rejection threshold. §4.6 contains ~145 [SLOT] markers; when filled, word count rises +245–405 → final: ~12,030–12,192 words. **A ~200w trim pass will be needed post-§4.6 fill-in** (target: §4.6 narrative or §6.4 examples, NOT §6.1/§6.3/§7). DO NOT cut §6.1 (core design argument), §6.2 (trimmed), §6.3 (feedback inversion), §7 (conclusion), §4.5 (~440 words - done).
...
7. ✅ CHI 2027 word limit and formatting confirmed (tick-4271): 5,000-8,000 encouraged; 12,000 max. Body currently **~11,707 words (under limit)** [updated tick-4369 — prior 11,727 tick-4330; 11,535 post-trim tick-4332; 17 refs; increments since push body to ~11,707 excluding inline annotations]. After §4.6 slot fill-in: ~12,000 - reserve ~400-word trim for post-data editing.
