...
_Status: All sections written. §4.6 Results pending Study 1 data collection (2026-Q3 pilot). Submission-clean pending OSF amendments O+T. Four-study arc: §7 updated tick-4397; abstract + §1.3 updated tick-4402. Study 4 DV1/DV2 dual-operationalisation propagated to abstract + §1.3 + §7 at tick-4418._
_Word count: ~11,823 words (body excl. tables + refs; tick-4418 +36w from §1.3+§7 Study 4 DV2 propagation; abstract change not counted). §4.6 fill-in adds +245–405w → final ~12,070–12,230w: trim pass needed post-fill (target §4.6 narrative or §6.4 examples). CHI cap 12,000 incl. refs, excl. tables. Open actions: JONY-ACTION O (OSF Amendment 5) + JONY-ACTION T (OSF Amendment 14)._
...
Two threads run through the empirical argument. First, Protective framing is necessary but not sufficient. Without a token label whose representational schema does not import the eCommerce-evidence association (§6.2), framing cannot fully override the wrong mental model on privacy-specific items. If H2 is supported, "vote fingerprint" holds the privacy-model advantage on Q2 — whether the identifier proves which option was voted for (§4.5) — while the overall accuracy composite remains equivalent. If H4 is also supported, "confirmation code" simultaneously reduces onboarding friction and degrades the privacy mental model; the deficit is not apparent to the user. The label and framing must be correct simultaneously; neither is sufficient alone. Study 2's pre-registered 2×2×2 factorial design (§5) operationalises the uncertainty Study 1 leaves open: whether absent-choice explanation is the load-bearing element that determines whether a familiar label ("confirmation code") can be rehabilitated through protective framing without substitution. Two pre-registered studies extend the empirical scope. Study 3 (pre-registered two-arm field pilot, N≥80) tests whether a public social-verification signal — a count of returned verifiers displayed on the post-vote receipt — increases post-vote verification return rates, operationalising the social-proof mechanism embedded in PIUP's post-vote verification affordance. Study 4 (pre-registered 2×2 vignette, N=160; UI-lock D × coercion pressure P) tests whether a UI-level temporal lock on the submission token produces genuine social deniability under adversarial pressure — where a technical barrier ("I cannot share it until the vote closes") is harder to override than a normative instruction alone (pre-registered DVs: sharing intent DV1, primary confirmatory; perceived social deniability of the technical excuse DV2, secondary confirmatory; §6.5).
...
**📏 WORD COUNT - UPDATED tick-4418 (2026-07-02):** Body text (annotations + submission notes stripped, refs included): **~11,823 words** (tick-4418: tick-4397 base ~11,787 + 36w Study 4 DV1/DV2 dual-operationalisation propagated to abstract + §1.3 + §7). 17 references. UNDER the 12,000 desk-rejection threshold. §4.6 contains ~145 [SLOT] markers; when filled, word count rises +245–405 → final: ~12,070–12,230 words. **A ~200–230w trim pass will be needed post-§4.6 fill-in** (target: §4.6 narrative or §6.4 examples, NOT §6.1/§6.3/§7). DO NOT cut §6.1 (core design argument), §6.2 (trimmed), §6.3 (feedback inversion), §7 (conclusion), §4.5 (~440 words - done).
...
7. ✅ CHI 2027 word limit and formatting confirmed (tick-4271): 5,000-8,000 encouraged; 12,000 max. Body currently **~11,823 words (under limit)** [updated tick-4418 — prior 11,787 tick-4397; 11,707 tick-4369; 11,535 post-trim tick-4332; 17 refs]. After §4.6 slot fill-in: ~12,070–12,230 — a ~200–230w trim pass will be needed post-data (target: §4.6 narrative or §6.4 examples). Do not pre-cut: trim only after §4.6 is filled.
