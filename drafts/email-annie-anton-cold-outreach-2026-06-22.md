...
_Author: Jony Bursztyn · 2026-06-22 (updated tick-4477, 2026-07-02 — Studies 2–4 pre-registered; four-study arc now reflected in email body)_
...
produces correct mental models of the system's privacy behavior in non-technical voters. The
evaluation is a four-study pre-registered arc: Study 1 (4-condition N=280 Prolific experiment;
14 confirmatory tests across 4 Holm-corrected hypothesis families) tests label design and
absent-content comprehension; Studies 2–4 extend to absent-content explanation calibration
under varied conditions, longitudinal verification return behavior in a live election, and
UI-enforced coercion-resistance testing. The system is live on Aztec v5 testnet; all four
pre-registrations and analysis scripts are in the public repo.
...
| **Study cited** | Study 2 (designed) as needing SPUD Lab methodology | Studies 1–4 (all pre-registered); Study 1 detailed as primary rigor signal |
...
_Updated tick-4477 (2026-07-02): Studies 2–4 pre-registered since original draft (2026-06-22). Email body updated to describe the full four-study empirical arc. Word count: ~404 words (original ~390 + 14 words for four-study description). Stays within the "2 minute read" target. The Antón-specific framing (requirements engineering ↔ UX complementarity) is unchanged._
