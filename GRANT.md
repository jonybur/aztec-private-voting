...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 2114, Jul 2 2026 ~07:28 UTC, ~50 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
