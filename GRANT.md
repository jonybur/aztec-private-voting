...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 1240, Jul 1 2026 ~14:13 UTC, ~51 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
