...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 1616, Jul 1 2026 ~21:28 UTC, ~60 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
