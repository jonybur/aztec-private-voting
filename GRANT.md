...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 1571, Jul 1 2026 ~20:43 UTC, ~85 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
