...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 1977, Jul 2 2026 ~04:43 UTC, ~50 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
