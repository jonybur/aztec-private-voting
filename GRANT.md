...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block ~978 post-second-reset, Jul 1 2026); deploy command ready in `docs/v5-upgrade-runbook.md` |
