...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 2619, Jul 2 2026 ~17:19 UTC, rollupVersion 2787991301 stable); deploy command ready in `docs/v5-upgrade-runbook.md` |
