...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 1624, Jul 1 2026 ~21:43 UTC, ~55 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
