...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block 1760, Jul 2 2026 ~00:15 UTC, ~55 blocks/hr post-second-reset); deploy command ready in `docs/v5-upgrade-runbook.md` |
