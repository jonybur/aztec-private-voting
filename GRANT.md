...
| Alpha testnet deployment | ⚠️ **Awaiting deployer keys** — v5 testnet RPC confirmed live (block ~11,800); deploy command ready in `docs/v5-upgrade-runbook.md` |
